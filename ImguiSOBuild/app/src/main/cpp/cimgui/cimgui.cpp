...
CIMGUI_API void AwakeKeyBoard(ImGui::CALLBACKAwakeKeyBoard cb){
     ImGui::AwakeKeyBoard(cb);
}

CIMGUI_API void SetKeyBoardAwakeStatus(bool status){
    ImGui::SetKeyBoardAwakeStatus(status);
}


CIMGUI_API int AddTest(int a,int b){
    return a+b;
}
