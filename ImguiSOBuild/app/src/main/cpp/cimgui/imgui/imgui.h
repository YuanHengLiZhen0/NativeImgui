...
namespace ImGui
{
    ...
    typedef void (*CALLBACKAwakeKeyBoard)(const char*);
    //static CALLBACKAwakeKeyBoard Callback_AwakeKeyBoard;
    //static bool IskeyBoardAwaked=false;
    IMGUI_API void AwakeKeyBoard(CALLBACKAwakeKeyBoard cb);
    IMGUI_API void SetKeyBoardAwakeStatus(bool status);
...
struct ImGuiIO
{
    ...
    bool IskeyBoardAwaked;
    ImGui::CALLBACKAwakeKeyBoard Callback_AwakeKeyBoard;
    IMGUI_API   ImGuiIO();
};
