...
ImGuiIO::ImGuiIO()
{
    ...
    IskeyBoardAwaked=false;
    Callback_AwakeKeyBoard=NULL;
}
...
void ImGui::AwakeKeyBoard(CALLBACKAwakeKeyBoard cb)
{
    //Callback_AwakeKeyBoard=cb;
    if(cb!=NULL){
        GetIO().Callback_AwakeKeyBoard=cb;
#ifdef __ANDROID__
        LOGD("Callback_AwakeKeyBoard is not Null");
#endif
    }
}

void ImGui::SetKeyBoardAwakeStatus(bool status){
     ImGuiIO& io = ImGui::GetIO();
